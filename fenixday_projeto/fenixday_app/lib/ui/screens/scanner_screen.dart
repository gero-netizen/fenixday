...
final _scannerResultsProvider = Provider<List<ScannerEntry>>((ref) => const [
  ScannerEntry(rank:1,  symbol:'BNB/USDT',  score:89, adx:12.1, atrPct:0.71, bbWidth:0.82, mm200Slope:0.3, volume24h:98_800_000),
  ScannerEntry(rank:2,  symbol:'XRP/USDT',  score:87, adx:14.8, atrPct:0.88, bbWidth:0.91, mm200Slope:0.4, volume24h:177_700_000),
  ScannerEntry(rank:3,  symbol:'DOGE/USDT', score:85, adx:13.5, atrPct:0.93, bbWidth:0.88, mm200Slope:0.5, volume24h:100_300_000),
  ScannerEntry(rank:4,  symbol:'ADA/USDT',  score:82, adx:16.2, atrPct:0.76, bbWidth:0.79, mm200Slope:0.6, volume24h:44_200_000),
  ScannerEntry(rank:5,  symbol:'LINK/USDT', score:80, adx:17.1, atrPct:0.82, bbWidth:0.85, mm200Slope:0.7, volume24h:46_900_000),
  ScannerEntry(rank:6,  symbol:'AVAX/USDT', score:79, adx:15.6, atrPct:0.88, bbWidth:0.94, mm200Slope:0.8, volume24h:64_700_000),
  ScannerEntry(rank:7,  symbol:'SUI/USDT',  score:77, adx:14.3, atrPct:0.97, bbWidth:1.02, mm200Slope:1.1, volume24h:38_300_000),
  ScannerEntry(rank:8,  symbol:'PEPE/USDT', score:76, adx:13.9, atrPct:1.05, bbWidth:1.08, mm200Slope:0.9, volume24h:53_400_000),
  ScannerEntry(rank:9,  symbol:'ZEC/USDT',  score:76, adx:11.8, atrPct:0.69, bbWidth:0.77, mm200Slope:0.4, volume24h:171_700_000),
  ScannerEntry(rank:10, symbol:'TAO/USDT',  score:75, adx:16.8, atrPct:0.94, bbWidth:0.98, mm200Slope:1.2, volume24h:123_200_000),
  ScannerEntry(rank:11, symbol:'ETH/USDT',  score:74, adx:18.4, atrPct:0.72, bbWidth:0.81, mm200Slope:1.4, volume24h:1_010_000_000),
  ScannerEntry(rank:12, symbol:'SOL/USDT',  score:72, adx:19.1, atrPct:0.94, bbWidth:0.99, mm200Slope:1.6, volume24h:365_200_000),
  ScannerEntry(rank:13, symbol:'PAXG/USDT', score:71, adx:10.2, atrPct:0.48, bbWidth:0.52, mm200Slope:0.2, volume24h:51_700_000),
  ScannerEntry(rank:14, symbol:'MATIC/USDT',score:70, adx:12.3, atrPct:0.70, bbWidth:0.80, mm200Slope:0.3, volume24h:48_700_000),
  ScannerEntry(rank:15, symbol:'BTC/USDT',  score:68, adx:20.1, atrPct:0.65, bbWidth:0.74, mm200Slope:1.8, volume24h:1_700_000_000),
  ScannerEntry(rank:16, symbol:'XAUT/USDT', score:68, adx:10.5, atrPct:0.46, bbWidth:0.51, mm200Slope:0.2, volume24h:41_400_000),
  ScannerEntry(rank:17, symbol:'JOE/USDT',  score:65, adx:14.2, atrPct:1.18, bbWidth:1.15, mm200Slope:1.9, volume24h:28_400_000),
  ScannerEntry(rank:18, symbol:'FTM/USDT',  score:64, adx:16.0, atrPct:0.92, bbWidth:0.95, mm200Slope:1.4, volume24h:32_100_000),
  ScannerEntry(rank:19, symbol:'CHZ/USDT',  score:63, adx:15.5, atrPct:0.85, bbWidth:0.91, mm200Slope:1.1, volume24h:27_600_000),
  ScannerEntry(rank:20, symbol:'SAND/USDT', score:61, adx:14.8, atrPct:0.99, bbWidth:1.04, mm200Slope:1.3, volume24h:35_200_000),
]);
